...
<link type="text/css" rel="stylesheet"
	href="<c:url value="/css/jquery.tablesorter.css" />" />
<link type="text/css" rel="stylesheet"
	href="<c:url value="/css/jquery.tablesorter.pager.css" />" />
				...
				<c:otherwise>
					...
					<div id="pager" class="pager">
						<form>
							...
							<img src="<c:url value="/img/tablesorter/pager/prev.png" />" class="prev" /> <input
								type="text" class="pagedisplay" /> <img
								src="<c:url value="/img/tablesorter/pager/next.png" />" class="next" /> <img
								src="<c:url value="/img/tablesorter/pager/last.png" />" class="last" /> <select
								class="pagesize">
